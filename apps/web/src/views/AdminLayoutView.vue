  ...
  <el-container class="layout">
    <el-aside width="200px" class="sidebar">
      ...
      <el-menu :default-active="route.path" router>
        ...
        <el-menu-item index="/admin/knowledge"><el-icon><Collection /></el-icon>知识管理</el-menu-item>
        ...
        <el-menu-item index="/admin/system-health"><el-icon><Monitor /></el-icon>系统监控</el-menu-item>
        <el-menu-item index="/admin/tasks"><el-icon><List /></el-icon>任务管理</el-menu-item>
        <el-divider style="margin:8px 0;border-color:#2d3f50" />
        <el-menu-item index="/" @click="router.push('/')"><el-icon><Back /></el-icon>返回学习端</el-menu-item>
      </el-menu>
    </el-aside>
    <el-container>
...
.sidebar .el-menu-item .el-icon { color: #409eff; }
