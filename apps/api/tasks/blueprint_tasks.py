...
async def _synthesize_blueprint_async(topic_key: str, space_id) -> None:
    ...
    async with SessionFactory2() as session:
        async with session.begin():  # 자동 커밋/롤백
            ...
            all_chapter_ids = []  # 收集所有章节id，用于均匀分配知识点
