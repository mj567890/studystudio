#!/usr/bin/env python3
"""
create_tutorial_view.py
直接在服务器上写出 TutorialView_8dim.vue，然后继续 Phase 2。

运行：cd ~/studystudio && python3 create_tutorial_view.py
"""
...
dest = ROOT / "TutorialView_8dim.vue"
dest.write_text(content, encoding="utf-8")
print(f"✓  TutorialView_8dim.vue 已写出到 {dest}")
print("  下一步：python3 apply_8dim_phase2.py")
